"""
Seed script: Insert Fault Line into the database as a playable game.

Usage (from backend/ directory):
    python -m scripts.seed_fault_line [--user-id <owner_user_id>]

If no user ID is given, it will use the first user found in the database.
"""
import asyncio
import sys
import uuid
...
# Make sure backend directory is on the path
    ...
    "content": {
        "questions": [
            ...
            },
            {
                ...
                "explanation": "The survey question matters enormously. Dentists may have been asked 'Do you recommend fluoride toothpaste?' and BrightSmile was simply one of many acceptable answers — not the top choice. Without knowing the question wording and the full range of choices, '4 out of 5' tells us almost nothing meaningful.",
                "difficulty": 1,
            ...
            },
            {
                ...
                "explanation": "Mrs. Rivera's actual argument is that challenging books build reading skills — a reasonable educational position. Your classmate has replaced that argument with a distorted, easy-to-attack version ('she wants to make our lives harder'). A Straw Man doesn't engage with what was actually said; it invents a weaker version to knock down.",
                "difficulty": 2,
            ...
            },
            {
                ...
                "explanation": "Both ice cream sales and drowning increase in summer because of a THIRD factor: hot weather. Hot weather makes people buy ice cream AND go swimming. This is called a 'confounding variable.' Correlation (two things moving together) is not causation (one thing causing the other). This confusion is one of the most dangerous reasoning errors in science, medicine, and public policy.",
                "difficulty": 2,
            ...
            },
            {
                ...
                "explanation": "Yes, millions of people can be wrong — and history proves it repeatedly. Billions once believed the Earth was flat. Popularity is not the same as truth. The only way to evaluate whether vaccines cause autism is through rigorous, peer-reviewed scientific studies — which overwhelmingly show no link. Numbers of believers is evidence of a belief, not evidence of a fact.",
                "difficulty": 3,
            ...
            },
            {
                ...
                "explanation": "A Slippery Slope claims that one reasonable step will inevitably trigger a chain of increasingly extreme consequences — without showing WHY each step in the chain would actually occur. Letting students choose essay topics doesn't logically lead to grade selection or academic collapse. Each step in the chain requires independent evidence to be credible.",
                "difficulty": 3,
            ...
            },
            {
                "id": "q8",
                "type": "multiple_choice",
                "stem": "Read this: 'Our school should switch to year-round schooling because studies show it improves student performance.' A critic responds: 'The only study that showed this was funded by a company that sells school air conditioning units.' Which response BEST evaluates this criticism?",
                "options": [
                ...
                "explanation": "Funding source is a legitimate flag for potential bias, but it doesn't automatically invalidate research. The right response is to examine the methodology, sample size, peer review status, and whether other independent studies reach the same conclusion. Dismissing a study purely because of funding is itself a form of Ad Hominem. Critical thinkers investigate; they don't just reject.",
                "difficulty": 3,
            ...
            },
            {
                ...
                "explanation": "'Experts say' is vague to the point of meaninglessness. Who are these experts? Are they oncologists or nutrition bloggers? What did they actually study? A headline can compress a careful 'may show some promise in early mouse trials' into 'CURES CANCER.' Before accepting health claims, trace the claim to its primary source: the actual study, its methodology, sample size, and peer-review status.",
                "difficulty": 3,
            ...
            },
            {
                ...
                "explanation": "This is a variation of Ad Hominem called 'Gatekeeping' — the idea that you must have a specific experience or credential to evaluate an argument. But arguments are evaluated on their logic and evidence, not the identity of who makes them. A student who researches anti-bullying policies can absolutely evaluate school decisions, even without being a principal. Otherwise, only principals could criticize principals — which would make accountability impossible.",
                "difficulty": 3,
            ...
            },
            {
                "id": "q11",
                "type": "multiple_choice",
                "stem": "An influencer posts: 'I switched to a plant-based diet and my energy doubled, my skin cleared up, and I lost 20 pounds. You should try it too!' What type of evidence is this, and why is it the WEAKEST form of evidence for a health recommendation?",
                "options": [
                ...
                "explanation": "Anecdotal evidence is a personal story (n=1). It cannot control for the dozens of other things that changed at the same time — the influencer may have also started sleeping more, quit drinking alcohol, or started exercising. We also don't know if their experience is typical or exceptional. Strong evidence requires large sample sizes, control groups, and replicated results across diverse populations.",
                "difficulty": 4,
            ...
            },
            {
                ...
                "explanation": "The opponent's actual position is that the military budget should be reduced — a debatable policy choice with many possible reasons (efficiency, reallocation to other defense areas, national debt). The politician has replaced this policy argument with an invented motive ('she doesn't care about protecting us'). This combines Straw Man (misrepresenting the position) with Ad Hominem (attacking character). Neither engages with the policy argument itself.",
                "difficulty": 4,
            ...
            },
            {
                "id": "q13",
                "type": "multiple_choice",
                "stem": "A company claims its new AI hiring tool is unbiased because 'it was built using objective data, and data can't be biased.' Identify the most significant flaw in this claim.",
                "options": [
                ...
                "explanation": "This is a critical real-world application of reasoning about data. Data is a record of human decisions — and human decisions can be systematically biased. An AI tool trained on resumes from decades when women and minorities were excluded from certain industries will learn that those groups are 'less qualified.' The word 'objective' describes the process of collection, not whether the underlying human decisions were fair. Algorithmic bias is one of the most important critical thinking topics of our era.",
                "difficulty": 4,
            ...
            },
            {
                "id": "q14",
                "type": "multiple_choice",
                "stem": "A classmate's argument: 'We should trust our school's dress code policy — it's been in place for 30 years, and tradition means it must work.' What fallacy is being used, and what would a STRONGER argument look like?",
                "options": [
                ...
                "explanation": "Appeal to Tradition argues that longevity equals validity — but something can be wrong for 30 years, or right for reasons that no longer apply. A stronger argument requires evidence of actual outcomes: has the dress code achieved measurable goals? Has it been evaluated against schools without dress codes? The age of a policy tells you only how old it is, not whether it works.",
                "difficulty": 4,
            ...
            },
            {
                "id": "q15",
                "type": "multiple_choice",
                "stem": "BOSS ROUND: A viral post argues: 'Scientists keep changing their minds about what's healthy — first eggs were bad, then they were good. So clearly scientists don't know anything, and we should trust our own instincts instead.' Identify ALL the reasoning errors in this argument.",
                "options": [
                    ...
                    {"id": "c", "text": "Appeal to Nature only — the argument suggests that natural instincts are more reliable than science", "is_correct": False},
                    {"id": "d", "text": "Straw Man only — the argument misrepresents what scientists actually claim about eggs", "is_correct": False}
                ],
                "explanation": "This is a multi-layered fallacy: (1) Hasty Generalization — two diet recommendations don't represent all scientific knowledge. (2) Misunderstanding of how science works — science revising conclusions when new evidence emerges is NOT a failure; it's the process working correctly. (3) False Dilemma — the alternative to 'trust scientists perfectly' isn't 'trust only your instincts.' Critical consumers of science learn to evaluate studies, check consensus, and distinguish preliminary findings from established science.",
                "difficulty": 5,
                "hints": ["Is 'scientists changed their minds' actually evidence that scientists are wrong? What does it actually show about the scientific method?"]
            }
        ]
    },
    "settings": {
...
async def seed():
    ...
    # Find or use provided user ID
    owner_id = None
    if len(sys.argv) >= 3 and sys.argv[1] == "--user-id":
        owner_id = sys.argv[2]
        print(f"Using provided user ID: {owner_id}")
    else:
        user = await db.users.find_one({})
        if user:
            owner_id = str(user.get("id") or user.get("_id"))
            print(f"Using first user found: {owner_id} ({user.get('email', 'unknown')})")
        else:
            print("ERROR: No users found in database. Create a user account first, then run this script.")
            client.close()
            return

    # Check if Fault Line already exists
    existing = await db.games.find_one({"title": "Fault Line"})
    if existing:
        print(f"Fault Line already exists (id: {existing.get('id')}). Updating spec...")
    ...
    print(f"✓ Fault Line inserted successfully!")
    print(f"  Game ID:  {game_id}")
    print(f"  Slug:     {slug}")
    print(f"  MongoDB:  {result.inserted_id}")
    print(f"\nPlay it at: /play/{game_id}")
    print(f"Edit it at: /studio/{game_id}")
